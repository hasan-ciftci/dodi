    ...
    return ScreenUtilInit(
        ...
        builder: () => MaterialApp(
              ...
              theme: ThemeData().copyWith(
                ...
                textTheme: TextTheme(
                  bodyText1: ThemeData().textTheme.bodyText1.copyWith(fontSize: 16.sp),
                  bodyText2: ThemeData().textTheme.bodyText2.copyWith(fontSize: 14.sp),
                  headline1: ThemeData().textTheme.headline1.copyWith(fontSize: 96.sp),
                  headline2: ThemeData().textTheme.headline2.copyWith(fontSize: 60.sp),
                  headline3: ThemeData().textTheme.headline3.copyWith(fontSize: 48.sp),
                  headline4: ThemeData().textTheme.headline4.copyWith(fontSize: 34.sp),
                  headline5: ThemeData().textTheme.headline5.copyWith(fontSize: 24.sp),
                  headline6: ThemeData().textTheme.headline6.copyWith(fontSize: 20.sp),
                  subtitle1: ThemeData().textTheme.subtitle1.copyWith(fontSize: 16.sp),
                  subtitle2: ThemeData().textTheme.subtitle2.copyWith(fontSize: 14.sp),
                  button: ThemeData().textTheme.button.copyWith(fontSize: 14.sp),
                  caption: ThemeData().textTheme.caption.copyWith(fontSize: 12.sp),
                  overline: ThemeData().textTheme.overline.copyWith(fontSize: 10.sp),
                )
              ),
              routes: {
