...
class QuizGradeTwelveView extends StatefulWidget {
  @override
  _QuizGradeTwelveViewState createState() => _QuizGradeTwelveViewState();
}

class _QuizGradeTwelveViewState extends State<QuizGradeTwelveView>
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        children: [
          ...
          if (questionModel.boldQuestionText == null) SizedBox(height: 16),
